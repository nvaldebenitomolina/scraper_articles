...
answer = input("Do you want to import tracker_37_modified.csv to intranet? y/n ")
...
if answer =='n':
	...
	button.click()
	driver.get("http://intranet.cr2.cl/tiki-tabular-list?tabularId=10");
	...
	time.sleep(1)
	driver.find_element_by_xpath('//*[@id="inputFile"]').send_keys(os.getcwd()+'/output_table/tracker_37_modified.csv')

	#driver.find_element_by_xpath('//*[@id="bootstrap-modal"]/div/div/div[3]/button[2]').click()
	print('tracker_37_modified.csv was uploaded to intranet')
