...
df= pd.DataFrame(columns = ["N","Funding Year","Progress report","Name of Research Line","Research Lines","Year Published",
"Authors original","CR2 Author","Authors","Title","Journal Name","ISSN","DOI","Url",
"Abstract Note","Pages","First page","Last page","Issue","Volume","Indexed/Not Indexed","Lines Collaboration",
"Researchers","Postdoc.","Undergraduated Students","Graduated Students","REGIONAL","FONDECYT","FONDEF","PIA",
"FONDAP","PAI","EXPLORA","International Cooperation","Astronomia","Becas (PCHA)","OTHER (specify)","SPECIFY","File"]
)
...
for n in range(0,len(authors_zotero)):
	...
	if 'Hitschfeld, N' in  authors_zotero[n] or  'Hitschfeld-Kahler, N' in authors_zotero[n] or 'HITSCHFELD, N' in authors_zotero[n]:
	...
	if 'De Polz-Holz, R' in  authors_zotero[n] or 'de Polz-Holz, R' in  authors_zotero[n] or 'De Pol-Holz, R' in  authors_zotero[n] or 'de Pol-Holz, R' in authors_zotero[n] or 'De Pot-Holz, R' in authors_zotero[n] or 'Holz, RD' in authors_zotero[n] or 'DePol-Holz, R' in authors_zotero[n] :
	...
	if 'O´Ryan, R'  in  authors_zotero[n] or "O'Ryan, R" in  authors_zotero[n] or 'O"Ryan, R' in authors_zotero[n] or "O''Ryan, R" in authors_zotero[n] or "O’Ryan, Raúl" in authors_zotero[n] or 'ORyan, RE' in authors_zotero[n] or "O’Ryan, Raúl" in authors_zotero[n]:
