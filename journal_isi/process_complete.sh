#!/bin/bash 
echo "First you have to export the table of Zotero,  normally you have to use cr2_2020_isi for the year corresponding & you must export it like 06_zotero.csv. Into 00_cr2_articles.csv you must add all DOI's for looking for them in the process ... but all the files have to be into input_table "
...
echo "Downloading master list of web of science..."
python 02_process_wos.py

sleep 5

echo "Download cites from Web of Science"
python 05_process_wos_cites.py

l=$(pwd)
echo "Moving files from Download to input_table"
mv /home/nvaldebenito/Descargas/savedrecs.txt $l/input_table/02_webofscience.csv
mv /home/nvaldebenito/Descargas/scopus.csv $l/input_table/01_scopus.csv
mv /home/nvaldebenito/Descargas/savedrecs.xls $l/input_table/03_webofscience.xls
echo "Import table manually, into masterlist  "

echo "Processing table national and international coolaboration on Scopus and Web of Science"
python2 03_national_inst_scopus.py
python2 04_national_inst_wos.py
